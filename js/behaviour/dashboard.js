$(function(){
    ...
    [30, 31 + randValue()]
      ...
      var plot_statistics = $.plot($("#chart3"), [{
        data: data_com, showLabels: true, label: "بازدیدکنندگان جدید", labelPlacement: "below", canvasRender: true, cColor: "#FFFFFF" 
      },{
        data: data_com2, showLabels: true, label: "بازدیدکنندگان قدیمی", labelPlacement: "below", canvasRender: true, cColor: "#FFFFFF" 
      }
      ], {
        series: {
          lines: {
