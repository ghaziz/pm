				...
				foreach($model as $task){
					...
					?><tr id="<?php echo 'u'.$task->id; ?>">
						<?php
							...
							<td><a href="<?php echo  $this->createUrl('comments/list',array('bind_type'=>'tasks','bind_id'=>$task->id,'title'=>$task->title)); ?>" title="تعداد نظرات"><span class="badge badge-danger"><?php echo PM::count_cmnt('tasks',$task->id);  ?></span></a> </td>
							<td>
